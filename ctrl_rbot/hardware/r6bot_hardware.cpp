...
// {
//   // 设置初始关节角度，例如：
//   joint_position_ = {0.0, -1.57, 1.57, 0.0, 1.57, 0.0};  // 6 个关节初始角度（单位：rad）
//   joint_position_command_ = joint_position_;            // 初始命令等于当前状态
//   joint_velocities_.assign(6, 0.0);
//   joint_velocities_command_.assign(6, 0.0);
...
PLUGINLIB_EXPORT_CLASS(
  ctrl_rbot::RobotSystem, hardware_interface::SystemInterface)
